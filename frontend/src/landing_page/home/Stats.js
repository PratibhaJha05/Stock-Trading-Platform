        ...
        <div className='container p-3'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.3+ crore customers trust Tradeora with ₹3.5+ lakh crores worth of equity investments</p>
                    ...
                    <h2 className='fs-4'>The Tradeora Universe</h2>
                ...
                <div className='col-6 p-5'>
                    <img src="Assets/ecosystem.png" alt="Ecosystem" style={{width:"90%"}} />
