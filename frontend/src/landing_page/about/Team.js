    ...
    <div className="container">
      ...
      >
        ...
        <div className="col-6 p-3">
          ...
          zen.</p>
        <p>Connect on  <a href="" alt="" style={{textDecoration:"none"}}>Homepage</a> / <a href="" alt="" style={{textDecoration:"none"}}>TradingQnA</a> / <a href="" alt="" style={{textDecoration:"none"}}>Twitter</a>
        </p>
        </div>
      </div>
    </div>
